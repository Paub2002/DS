...
public final class DirectoryUsers {
  ...
  public static void makeUsers() {
    ...
    // this is to withdraw all permissions but still to keep user data to give back
    // permissions later
    Role temporaryUserRole = new Role("Temporary User", Arrays.asList(), Arrays.asList("stairs","room1","room2","room3","hall","IT"), null, null, null, null, null, null, null);
    ...
    // just shortly unlock
    // ground floor, floor1, exterior, stairs (this, for all), that is, everywhere but the parking
    Role employeeRole = new Role("Employee", Arrays.asList("open", "close", "unlock_shortly"), Arrays.asList("stairs","room1","room2","room3","hall","IT"), 2024, 2025, 9, 3, 9, 17, Arrays.asList(1, 2, 3, 4, 5));
    ...
    // all actions
    // all spaces
    Role managerRole = new Role("Manager", Arrays.asList("lock", "unlock", "open", "close"), Arrays.asList("parking","stairs","room1","room2","room3","hall","IT"), 2024, 2025, 9, 3, 8, 20, Arrays.asList(1, 2, 3, 4, 5, 6));
    ...
    // all actions
    // all spaces
    Role adminRole = new Role("Admin", Arrays.asList("lock", "unlock", "open", "close"), Arrays.asList("stairs","room1","room2","room3","hall","IT"), 2024, 2100, 1, 1, null, null, Arrays.asList(1, 2, 3, 4, 5, 6,7));
